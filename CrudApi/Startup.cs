...
namespace CrudApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Adicionando o Entity Framework para criar o banco dados
            //Lincando o banco de dados. Criaremos as migarations (tabela candidatos/vagas)
            //Ao invocar Interface, a injeção de dependência usará todos os métodos do repositório.
        }
